...
También se emplean bucles while (while i < len(limpia):) en normalizar_formula_quimica y _obtener_conteo_de_elementos_en_formula para procesar las cadenas de fórmulas carácter por carácter.
...
- normalizar_formula_quimica(formula_str): Esta es una función crucial.
  * Toma la fórmula ingresada por el usuario (ej., "h2o", "NACL", "-Fe") y la limpia y formatea.
...
- Ejecuta el programa:
  ...
  * Bash python calculadora_peso_molecular.py
